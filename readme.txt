...
QuBic_Idioma allows to have different instances of a blog using different languages on a network installation.
...
Upload the QuBic_Idioma plugin and you're done!
